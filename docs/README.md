...
| What is an investment assessment? | [`architecture/INVESTMENT_ASSESSMENT.md`](architecture/INVESTMENT_ASSESSMENT.md) — **proposed**: the bounded evaluative claim that offers a course to a decision; it offers, never decides, and what its inputs cannot support it refuses |
