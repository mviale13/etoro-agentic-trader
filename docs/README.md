...
| What is knowledge, once the reader is known to vary? | [`architecture/KNOWLEDGE_CONSENSUS.md`](architecture/KNOWLEDGE_CONSENSUS.md) — **proposed, not agreed**: observation vs consensus, and the content-blind rule that separates them |
