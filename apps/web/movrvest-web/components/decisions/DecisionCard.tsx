...
interface DecisionCardProps {
  /** Position in the conviction order. Null or absent where the case
   *  carries no conviction — there is no order to hold a place in, and
   *  the badge is not rendered rather than showing a number over one. */
  rank?: number | null;
  symbol: string;
